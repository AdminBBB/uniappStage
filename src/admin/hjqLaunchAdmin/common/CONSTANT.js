...
export const DEFAULT_CURRENT_DATA = { itemName: null, department: null, regionCode: [], provCode: [], system: 3, minVersion: null, maxVersion: null, tagType: 1, tagTxt: '', itemNote: '', tag: '' };
