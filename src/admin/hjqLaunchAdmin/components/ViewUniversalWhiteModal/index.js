...
import { ViewAuthorityBasicInfo } from '../ViewAuthorityBasicInfo';
import { getSaveWhiteList, getDeleteAuthority } from '../../views/UniversalManage/service/api.js';
...
export function ViewUniversalWhiteModal (props) {
    ...
    const { viewUniversalWhiteItem, authTypeList } = state;
